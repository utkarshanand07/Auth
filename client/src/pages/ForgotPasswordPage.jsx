...
const ForgotPasswordPage = () => {
	...
	return (
		<motion.div
			...
			className='max-w-md w-full bg-gray-800 bg-opacity-50 backdrop-filter backdrop-blur-xl rounded-2xl shadow-xl overflow-hidden font-[Montserrat]'
		>
			<div className='p-8'>
				...
				{!isSubmitted ? (
					<form onSubmit={handleSubmit} className='font-[Montserrat]'>
						<p className='text-gray-300 mb-6 text-center font-[Montserrat]'>
			...
			<div className='px-8 py-4 bg-gray-900 bg-opacity-50 flex justify-center font-[Montserrat]'>
				<Link to={'/login'} className='text-sm text-blue-400 hover:underline flex items-center font-[Montserrat]'>
